    ...
    for s in sensors_list:
        for sp in positions_list:
            for f in features_list:
                ...
                print('$$$ LEG : ', LEG)
                # Feature Selection
                train = fs.sensors_features(train, pos=SENSOR_POS, group=FEATURES_GROUP, sensor=SENSOR_TYPE, leg=LEG)
                test = fs.sensors_features(test, pos=SENSOR_POS, group=FEATURES_GROUP, sensor=SENSOR_TYPE, leg=LEG)
...
results_df.to_csv('../results/train_test.csv', sep=',', index=False)
